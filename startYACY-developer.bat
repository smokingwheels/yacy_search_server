...
REM Always run from the YaCy installation/source directory.
REM This keeps DATA beside startYACY.bat, which is suitable for developers
REM and also supports installations on drives such as I:\.
cd /d "%~dp0"
set "YACY_HOME=%~dp0"
set "YACY_DATA_DIR=%YACY_HOME%DATA"
...
start "YaCy" %priority% javaw %javacmd% -classpath "%CLASSPATH%" net.yacy.yacy %1 %2 %3 %4 %5 %6 %7 %8 %9

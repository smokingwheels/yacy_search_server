...
set JAVA_OPTS=-Xms512m -Xmx4096m -XX:MaxMetaspaceSize=256m ^
-XX:+UseG1GC -XX:MaxGCPauseMillis=200 ^
-XX:+HeapDumpOnOutOfMemoryError ^
-Dsolr.directoryFactory=solr.StandardDirectoryFactory ^
-Dorg.apache.lucene.store.MMapDirectory.enable=false ^
-Dlucene.merge.scheduler.maxThreadCount=1 ^
-Dlucene.merge.scheduler.autoThrottle=true ^
-Dorg.apache.lucene.store.MMapDirectory.enableMemoryMapping=false ^
-Dorg.apache.lucene.store.FSDirectory.class=org.apache.lucene.store.NIOFSDirectory ^
-Dsolr.directoryFactory=solr.StandardDirectoryFactory
